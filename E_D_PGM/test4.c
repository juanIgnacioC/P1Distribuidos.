...
//         Mandar la matriz
    ...
    if(my_rank == 5){
        printf("%d Quinto elemento estructurante\n", my_rank);
...
//         Mandar la matriz
            MPI_Send(local5, rango5*(colu-1), MPI_UNSIGNED_CHAR, 0, 0, MPI_COMM_WORLD);
    }
...
/*
        ...
        printf("Archivos ErosionThread$n.pgm satisfactoriamente creados\n");
