...
//         recibe lass dos matrices y las guarda
        ...
        sali=fopen("erosionThread2.pgm","wb");
        fprintf(sali,"P5\n");
        fprintf(sali,"# Creado por Juan Cordero y Alvaro Elgueda.\n");
        fprintf(sali,"%d %d\n",colu,fila);
        fprintf(sali,"%d\n",gris);
        for(i=0; i<fila; i++){
            for(j=0; j<colu; j++)
            {
                fprintf(sali,"%c",otra2[i][j]);
            }
        }

        sali=fopen("erosionThread3.pgm","wb");
        fprintf(sali,"P5\n");
        fprintf(sali,"# Creado por Juan Cordero y Alvaro Elgueda.\n");
        fprintf(sali,"%d %d\n",colu,fila);
        fprintf(sali,"%d\n",gris);
